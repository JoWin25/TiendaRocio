...
<div class="row">
	<div class="col-md-12">
		<h1>Bienvenido a la Tienda Rocío</h1>
</div>
</div>
  <div class="row">
...
foreach($products as $product):
	...
	<tr class="<?php if($q==0){ echo "danger"; }else if($q<=$product->inventary_min/5){ echo "danger"; } else if($q<=$product->inventary_min){ echo "warning"; } ?>">
		<td><?php echo $product->id; ?></td>
		<td><?php echo $product->name; ?></td>
		<td><?php echo $q; ?></td>
		<td>
		<?php if($q==0){ echo "<span class='label label-danger'>No hay existencias.</span>";}else if($q<=$product->inventary_min/5){ echo "<span class='label label-danger'>Quedan muy pocas existencias.</span>";} else if($q<=$product->inventary_min){ echo "<span class='label label-warning'>Quedan pocas existencias.</span>";} ?>
		</td>
	</tr>
<?php endif;?>
<?php
